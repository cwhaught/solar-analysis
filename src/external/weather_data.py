...
def get_weather_data(lat, lon, start_date, end_date):
    ...
    if response.status_code == 200:
        ...
        weather_df.columns = [
            ...
            'sunshine_duration_s', 'precipitation_mm',
            'windspeed_max_kmh', 'solar_radiation_mj',
            'cloudcover_mean_pct'
        ]
        ...
        weather_df['solar_weather_score'] = (
                ...
                ((100 - weather_df['cloudcover_mean_pct']) / 100) * 0.4 +  # Clear sky weight
                (weather_df['solar_radiation_mj'] / weather_df['solar_radiation_mj'].max()) * 0.2
